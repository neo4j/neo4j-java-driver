...
public interface PropertyEncryptionRequest {
     ...
     *
     * @return the new instance of a build stage
     */
    ...
    interface Builder {
        ...
        interface AADStep extends ProfileStep {
             ...
             *     <li>{@link TypeSystem#STRING()} - it is strongly recommended to normalize the value, for example
             *     using {@link java.text.Normalizer.Form#NFC}, before passing it to the driver</li>
        ...
        /**
         * A builder step for selecting encryption profile.
         */
        interface ProfileStep extends EncryptionKeyReferenceStep {
            /**
             * Sets the profile name to use.
             *
             * @param profileName the profile name, must not be {@literal null}
             * @return the next builder step
             */
        ...
        interface EncryptionKeyReferenceStep {
             ...
             *
             * @param keyId the key id, must not be {@literal null}
             * @return the next builder step
             */
             ...
             *
             * @param keyAlias the key alias, must not be {@literal null}
             * @return the next builder step
             */
