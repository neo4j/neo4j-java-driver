...
/**
 * Provides Neo4j Property Encryption asynchronous functions.
 *
...
public interface AsyncPropertyEncryption extends BasePropertyEncryption {
     ...
     * @return a {@link CompletionStage} that completes with the encrypted bytes
     */
    CompletionStage<byte[]> encryptToBytesAsync(PropertyEncryptionRequest encryptionRequest);
     ...
     * @return a {@link CompletionStage} that completes with the decrypted value
     */
    CompletionStage<Value> decryptAsync(PropertyDecryptionRequest decryptionRequest);
