 ...
 */
package org.neo4j.driver.encryption.reactivestreams;
...
/**
 * Provides Neo4j Property Encryption reactive functions.
 *
 * @see org.neo4j.driver.encryption.PropertyEncryption
...
public interface ReactivePropertyEncryption extends BasePropertyEncryption {
     ...
     * @return a {@link Publisher} that publishes the encrypted bytes
     */
    Publisher<byte[]> encryptToBytes(PropertyEncryptionRequest encryptionRequest);
     ...
     * @return a {@link Publisher} that publishes the decrypted value
     */
    Publisher<Value> decrypt(PropertyDecryptionRequest decryptionRequest);
