...
public class InternalExplicitTransaction implements ExplicitTransaction
{
    private enum State
    {
    ...
    public InternalExplicitTransaction( Connection connection, BookmarksHolder bookmarksHolder )
    {
