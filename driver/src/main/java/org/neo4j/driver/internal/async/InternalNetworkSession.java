...
public class InternalNetworkSession implements NetworkSession
{
    ...
    public InternalNetworkSession( ConnectionProvider connectionProvider, RetryLogic retryLogic, String databaseName, AccessMode mode,
    ...
    public CompletionStage<ExplicitTransaction> beginTransactionAsync( AccessMode mode, TransactionConfig config )
    {
        ...
        CompletionStage<ExplicitTransaction> newTransactionStage = ensureNoOpenTxBeforeStartingTx()
                ...
                {
                    ExplicitTransaction tx = new InternalExplicitTransaction( connection, bookmarksHolder );
