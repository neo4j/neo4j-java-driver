...
public class HandshakeCompletedListener implements ChannelFutureListener {
    ...
    public HandshakeCompletedListener(
            String userAgent, RoutingContext routingContext, ChannelPromise connectionInitializedPromise, Clock clock) {
    ...
    public void operationComplete(ChannelFuture future) {
        if (future.isSuccess()) {
            ...
            if (BoltProtocolV51.VERSION.compareTo(protocol.version()) > 0) {
                ...
                protocol.initializeChannel(userAgent, null, routingContext, connectionInitializedPromise, clock);
            }
        } else {
