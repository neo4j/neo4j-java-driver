...
public class ConnectionProviders {
    static ConnectionProvider netty(
            EventLoopGroup group, Clock clock, DomainNameResolver domainNameResolver, LoggingProvider logging) {
        return new NettyConnectionProvider(group, clock, domainNameResolver, logging);
    }
}
