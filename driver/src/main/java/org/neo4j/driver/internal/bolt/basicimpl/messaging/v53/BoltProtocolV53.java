...
import static org.neo4j.driver.internal.bolt.basicimpl.async.connection.ChannelAttributes.setHelloStage;
...
public class BoltProtocolV53 extends BoltProtocolV52 {
    ...
    public void initializeChannel(
        ...
        setHelloStage(channel, helloFuture.thenApply(ignored -> null));
