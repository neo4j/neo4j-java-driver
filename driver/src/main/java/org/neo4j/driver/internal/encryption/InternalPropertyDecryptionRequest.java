...
public final class InternalPropertyDecryptionRequest extends AbstractPropertyRequest
        implements PropertyDecryptionRequest.Builder.ValueStep,
                PropertyDecryptionRequest.Builder.AADStep,
                PropertyDecryptionRequest.Builder.BuildStep,
    ...
    @Override
    public Builder.AADStep fromValue(byte[] value) {
