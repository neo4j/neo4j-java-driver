...
public final class LocalKeyEncapsulationService implements AsyncKeyEncapsulationService {
    ...
    public CompletionStage<KeyEncapsulationResult> encapsulateAsync(KeyEncapsulationOptions options) {
        ...
        try {
            ...
            return CompletableFuture.completedStage(KeyEncapsulationResult.of(
                    encryptedDek, Map.of("iv", Base64.getEncoder().encodeToString(iv)), dek));
        } catch (Exception e) {
            throw new PropertyEncryptionException("Failed to encapsulate key", e);
        }
    }
    ...
    public CompletionStage<SecretKey> decapsulateAsync(byte[] encapsulation, Map<String, String> metadata) {
        ...
        try {
            ...
            throw new PropertyEncryptionException("Failed to decrypt data", e);
        }
    }
