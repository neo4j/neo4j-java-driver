...
final class MicrometerPoolConnectionCreateObservation extends AbstractObservation {
    private final MicrometerConnectionPoolMetrics metrics;
    private final MeterRegistry meterRegistry;
    private volatile Timer.Sample sample;

    MicrometerPoolConnectionCreateObservation(MicrometerConnectionPoolMetrics metrics, MeterRegistry meterRegistry) {
