...
public interface EncryptionHandler {
    ...
    CompletionStage<byte[]> encrypt(InternalPropertyEncryptRequest encryptionRequest);

    CompletionStage<Value> decrypt(
            InternalPropertyDecryptRequest decryptionRequest, AEADEncryptedProperty aadEncryptedProperty);
