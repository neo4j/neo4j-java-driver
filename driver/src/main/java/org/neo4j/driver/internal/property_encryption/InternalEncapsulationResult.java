...
public record InternalEncapsulationResult(byte[] encapsulation, KeyEncapsulationOptions options, SecretKey key)
        implements KeyEncapsulationService.EncapsulationResult {}
