...
public final class InternalPropertyDecryptRequest extends AbstractPropertyRequest
        implements PropertyDecryptRequest.ValueStep,
                PropertyDecryptRequest.AADStep,
                PropertyDecryptRequest.BuildStep,
                PropertyDecryptRequest {
    byte[] value;
    ...
    @Override
    public PropertyDecryptRequest build() {
        return this;
    }
}
