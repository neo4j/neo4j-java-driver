...
public interface PropertyDecryptRequest {
    ...
    /**
     * A builder step for building {@link PropertyDecryptRequest}.
     */
    interface BuildStep {
        /**
         * Builds and returns a new {@link PropertyDecryptRequest} instance.
         * @return the new request instance
         */
        PropertyDecryptRequest build();
    }
}
