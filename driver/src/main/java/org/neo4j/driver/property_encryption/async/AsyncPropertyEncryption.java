...
public interface AsyncPropertyEncryption extends BasePropertyEncryption {
     ...
     */
    CompletionStage<byte[]> encryptToBytesAsync(PropertyEncryptionRequest encryptRequest);
     ...
     */
    CompletionStage<Value> decryptAsync(PropertyDecryptionRequest decryptRequest);
