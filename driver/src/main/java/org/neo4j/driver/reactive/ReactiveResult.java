...
public interface ReactiveResult {
     ...
     * <p>
     * When the record publisher is {@linkplain Flow.Publisher#subscribe(Flow.Subscriber) subscribed}, the query is executed and the result is streamed back as a record
     ...
     * <p>
     * Therefore the {@link Flow.Subscriber} of this record publisher shall wait for the termination signal (complete or error) to ensure that the resources used by
     ...
     * the execution is finished, the {@link Flow.Subscriber} will be notified with a termination signal (complete or error).
     * <p>
     ...
     * <p>
     * {@linkplain Flow.Publisher#subscribe(Flow.Subscriber) Subscribing} the summary publisher results in the execution of the query followed by the result summary being
