...
public class Config
{
    ...
    public static class ConfigBuilder
    {
        ...
        /**
         * Pooled connections that have been unused for longer than this timeout will be tested before they are
         * used again, to ensure they are still live. Setting this to a low value makes it less likely that you
         * will see connection errors in your application, but setting it too low means your application will
         * need to wait more often while a connection test is performed.
         * <p>
         * You should generally not modify this unless you are having trouble with connection errors or with
         * connection tests showing up your performance profiler.
         *
