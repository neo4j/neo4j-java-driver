 ...
 * <p>
 * Value that represents a duration can be created using {@link Values#cypherDuration(long, long, long, long)} method.
 */
@Immutable
public interface CypherDuration extends TemporalAmount
{
    /**
