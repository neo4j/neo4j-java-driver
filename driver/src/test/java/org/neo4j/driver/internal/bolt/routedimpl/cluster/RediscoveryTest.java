...
//    private final Function<BoltServerAddress, BoltConnectionProvider> pool = asyncConnectionPoolMock();
//
//    @Test
...
//                        rediscovery.lookupClusterComposition(table, pool, Collections.emptySet(), null, null, new
// BoltProtocolVersion(4,1)))
...
//                () -> await(rediscovery.lookupClusterComposition(table, pool, Collections.emptySet(), null, null, new
// BoltProtocolVersion(4,1))));
...
//        var initialRouter = A;
//        var noWritersComposition = new ClusterComposition(42, asOrderedSet(D, E), emptySet(), asOrderedSet(D, E),
// null);
...
//                new RediscoveryImpl(A, compositionProvider, resolver, logging,
...
//    }
//
//    private static Function<BoltServerAddress, BoltConnectionProvider> asyncConnectionPoolMock() {
//        return address -> {
//            var boltConnectionProvider = mock(BoltConnectionProvider.class);
//            given(boltConnectionProvider.connect(any(), any(), any(), any(), any(), any(), any(),
// any())).willReturn(completedFuture(asyncConnectionMock(address)));
//            return boltConnectionProvider;
//        };
//    }
//
//    private static BoltConnection asyncConnectionMock(BoltServerAddress address) {
