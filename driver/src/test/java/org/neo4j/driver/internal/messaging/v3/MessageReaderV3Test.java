...
/**
 * The MessageReader under tests is the one provided by the {@link BoltProtocolV3} and not an specific class implementation.
 * <p>
...
public class MessageReaderV3Test extends AbstractMessageReaderTestBase
{
    ...
    {
        return BoltProtocolV3.INSTANCE.createMessageFormat().newReader( input );
    }
