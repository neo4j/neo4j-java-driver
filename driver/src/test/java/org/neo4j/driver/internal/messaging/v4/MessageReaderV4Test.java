...
/**
 * The MessageReader under tests is the one provided by the {@link BoltProtocolV4} and not an specific class implementation.
 * <p>
 * It's done on this way to make easy to replace the implementation and still getting the same behaviour.
 */
public class MessageReaderV4Test extends AbstractMessageReaderTestBase
{
    ...
    {
        return BoltProtocolV4.INSTANCE.createMessageFormat().newReader( input );
    }
