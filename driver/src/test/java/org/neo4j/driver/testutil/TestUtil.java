...
public final class TestUtil {
    ...
    //        verify(connectionMock, times(times)).writeAndFlush(any(BeginMessage.class),
    ...
    public static BoltConnection connectionMock(BoltProtocolVersion protocol) {
        return connectionMock(WRITE, protocol);
    }

    public static BoltConnection connectionMock(AccessMode mode, BoltProtocolVersion protocol) {
        return connectionMock(null, mode, protocol);
    }

    public static BoltConnection connectionMock(String databaseName, BoltProtocolVersion protocol) {
        return connectionMock(databaseName, WRITE, protocol);
    }

    public static BoltConnection connectionMock(
            String databaseName, AccessMode mode, BoltProtocolVersion protocolVersion) {
