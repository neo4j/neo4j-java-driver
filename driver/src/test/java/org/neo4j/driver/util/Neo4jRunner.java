...
public class Neo4jRunner {
    ...
    public static final String NEOCTRL_ARGS =
            System.getProperty("neoctrl.args", ENV_NEOCTRL_ARGS == null ? DEFAULT_NEOCTRL_ARGS : ENV_NEOCTRL_ARGS);
    public static final Config DEFAULT_CONFIG =
            Config.builder().withLogging(console(INFO)).withoutEncryption().build();
    ...
    private Neo4jRunner() throws IOException {
        try {
            ...
            try {
                ...
                debug("Failed to start server first time due to error: "
                        + ErrorUtil.getRootCause(e).getMessage());
