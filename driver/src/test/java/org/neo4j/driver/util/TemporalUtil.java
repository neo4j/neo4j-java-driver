...
public final class TemporalUtil
{
    ...
    private static final List<String> BLACKLISTED_ZONE_IDS = Arrays.asList(
            ...
            "tzid",
            "Asia/Qostanay",
            "America/Santiago" // Can cause flakyness on windows newer versions, see https://stackoverflow.com/questions/37533796/java-calendar-returns-wrong-hour-in-ms-windows-for-america-santiago-zone.
            );
