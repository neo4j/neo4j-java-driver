...
public class TemporalTypesIT
{
    ...
    {
        testSendValue( newDuration( 8, 12, 90, 8 ), Value::asCypherDuration );
    }
    ...
    public void shouldReceiveDuration()
    {
        testReceiveValue( "RETURN duration({months: 13, days: 40, seconds: 12, nanoseconds: 999})",
                ...
                Value::asCypherDuration );
    }

    @Test
    public void shouldSendAndReceiveDuration()
    {
        testSendAndReceiveValue( newDuration( 7, 7, 88, 999_999 ), Value::asCypherDuration );
    }

    @Test
    public void shouldSendAndReceiveRandomDuration()
    {
        testSendAndReceiveRandomValues( TemporalUtil::randomDuration, Value::asCypherDuration );
    }
    ...
    {
        return cypherDuration( months, days, seconds, nanoseconds ).asCypherDuration();
    }
}
