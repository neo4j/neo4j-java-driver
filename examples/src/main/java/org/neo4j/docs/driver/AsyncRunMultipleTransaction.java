...
public class AsyncRunMultipleTransaction extends BaseApplication
{
    public AsyncRunMultipleTransaction( String uri, String user, String password )
    {
    ...
    public CompletionStage<Integer> addEmployees( final String companyName )
    {
        ...
        return session.readTransactionAsync( AsyncRunMultipleTransaction::matchPersonNodes )
