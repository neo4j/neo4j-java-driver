...
import org.neo4j.driver.observation.metrics.internal.InternalConnectionPoolMetrics;
...
public sealed interface ConnectionPoolMetrics permits InternalConnectionPoolMetrics {
    /**
