...
@Setter
@Getter
public class AuthTokenManagerClose extends AbstractBasicTestkitRequest {
    ...
    protected TestkitResponse processAndCreateResponse(TestkitState testkitState) {
        ...
        return AuthTokenManager.builder()
                .data(AuthTokenManager.AuthTokenManagerBody.builder()
                        .id(data.getId())
                        .build())
                .build();
    }
